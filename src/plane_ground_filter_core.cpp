...
PlaneGroundFilter::PlaneGroundFilter(ros::NodeHandle &nh)
{
    ...
    sub_point_cloud_ = nh.subscribe(input_topic, 10, &PlaneGroundFilter::point_cb, this); // 输入topoc   /velodyne_points   OR  /kitti/velo/pointcloud
...
void PlaneGroundFilter::point_cb(const sensor_msgs::PointCloud2ConstPtr &in_cloud_ptr)
{
    ...
    groundless_msg.header.frame_id = "camera_init";
    ...
    all_points_msg.header.frame_id = "camera_init";
